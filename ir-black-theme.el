...
(let ((*background-color*   "#101010")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-delimiter-face ((t (:foreground, *string-inner*))))
   `(font-lock-comment-face ((t (:foreground, *string-inner*))))
   `(font-lock-constant-face ((t (:foreground, *constant*))))
   `(font-lock-doc-face ((t (:foreground, *string*))))
   `(font-lock-doc-string-face ((t (:foreground, *string*))))
   `(font-lock-function-name-face ((t (:foreground, *method-declaration*))))
   `(font-lock-keyword-face ((t (:foreground, *comments*))))
   ...
   `(font-lock-type-face ((t (:foreground, *variable*))))
   `(font-lock-variable-name-face ((t (:foreground, *keywords*))))
   ...
   `(mode-line-buffer-id ((t (:foreground, *string-inner* :weight bold))))
   `(cursor ((t (:background "#ff0070" :foreground "#000000"))))
   ...
   `(show-paren-match ((t (:background, *brown* :foreground, *background-color* :weight bold))))

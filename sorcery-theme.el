...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF)))
  ...
  (mode-line                  (:foreground fg :background "#282828"))
  (mode-line-buffer-id        (:foreground c9 :weight 'bold))
  ...
  (cursor                     (:background "#ff0068" :foreground bg))
  ...
  (font-lock-comment-delimiter-face          (:foreground c6))
  (font-lock-comment-face                    (:foreground c6))
...

  ...
  (ivy-current-match               (:foreground c5 :weight 'bold))
